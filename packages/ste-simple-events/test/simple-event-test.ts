...
import { SimpleEventDispatcher, SimpleEventList, NonUniformSimpleEventList } from "./../src/";
...
describe("Strongly Typed Events - Simple event", function () {
  ...
  describe("NonUniformSimpleEventList", function () {
    it("Subscribe to event name", function () {
      type ArgMap = { "myEvent": number };
      let list = new NonUniformSimpleEventList<ArgMap>();
      var fn = (nr: number) => { };
